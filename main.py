...
janela.geometry("235x310")  # Definindo a sua largura e comprimento
...
def entrar_valores(valor):
    ...
    todos_os_valores = todos_os_valores + str(valor)
...
b_17 = Button(frame_corpo, command=lambda: entrar_valores("."),  text=".", width=5, height=2, bg=cor5, fg=cor2,
              font=('Ivy 13 bold'),
              relief=RAISED, overrelief=RIDGE)
